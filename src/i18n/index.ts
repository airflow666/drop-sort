...
const RU = {
  ...
  'product.weekPass.note': 'Ежедневная награда монетами и подсказками на 7 дней.',
  ...
  'toast.passActive': 'Пропуск активирован',
...
const EN: Record<Key, string> = {
  ...
  'product.weekPass.note': 'A daily reward of coins and hints for 7 days.',
  ...
  'toast.passActive': 'Pass activated',
